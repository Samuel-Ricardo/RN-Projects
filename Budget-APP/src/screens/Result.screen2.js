...
class Result extends React.PureComponent {
    ...
    constructor(props) {
        ...
        AsyncStorage.getItem('auth_user').then(data => {
            ...
            console.log("")
            console.log("Get User to Result2")
            console.log("")
            console.log(user)
            console.log("")
    ...
    _renderCategories() {
        return this.props.budget_categories.map((val, key) => {
            ...
            return( 
             <View key={val.title} style={ [styles.flexRow, styles.resultList, styles.paddingVertical, this.props.budget_categories.length != key +1 ? { borderBottomWidth: 2, borderBottomColor: colors.backgroundGray, paddingBottom: 8} : {}] }>
            ...
            return (<View style={[ {flex: 1, justifyContent: 'center', alignItems: 'center'}]}>
                <TouchableOpacity style={[
                    ...
                    {  backgroundColor: 'transparent',
                        ...
                        borderWidth: 1,
                        marginTop: 10
                    }]} onPress={() => { this.props.actionGetBudgetFromServer(this.state.user);}}
                >
