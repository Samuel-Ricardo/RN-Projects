...
class Edit extends React.PureComponent {
    ...
    _handleUpdateBudget() {
        ...
        onsole.log("")
            console.log("State user header")
            console.log("")
            console.log(this.state.user)

        const auth_token = "Bearer " + this.state.user.authenticationToke
    ...
    _addExpense() {
        ...
        this.setState({ categories: temp, dataSource: this.state.dataSource.cloneWithRows(temp) });
    }
