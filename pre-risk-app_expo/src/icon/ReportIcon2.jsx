...
export default ({ width, height, fill }) => {
  ...
  return (
    ...
    <Svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 490 490" style="enable-background:new 0 0 490 490;" xmlSpace="preserve" fill={fill}>
      <G>
        <G>
          <G>
            ...
            <Rect x="345" y="130" width={width} height={height} />
            <Rect x="345" y="160" width={width} height={height} />
            <Rect x="345" y="190" width={width} height={height} />
            <Rect x="345" y="100" width={width} eight={height} />
            <Path d="M324.999,119.999v-20h-45c-2.652,0-5.196,1.054-7.071,2.929l-15,15l14.143,14.143l12.07-12.072H324.999z" />
            <Rect x="310" y="235" width={width} height={height} />
            <Rect x="280" y="270" width={width} height={height} />
          </G>
        </G>
      </G>
      <G>
